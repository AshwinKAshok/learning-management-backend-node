# Learning-management-system project - backend implementation using NodeJS and MongoDB

This is the backend implementation for the project "Learning-management-system". It is implemented 
using NodeJs and MongoDB. It is an attempt to learn NodeJS and MongoDB by trying to implementing all
